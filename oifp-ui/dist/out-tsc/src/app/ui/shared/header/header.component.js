...
var HeaderComponent = /** @class */ (function () {
    function HeaderComponent(investorService, userInvestmentsService) {
        this.investorService = investorService;
        this.userInvestmentsService = userInvestmentsService;
        this.isVisible = false;
        this.currentUser = null;
        this.greetingMsg = 'Hello';
        this.investmentAmount = 0.00;
    ...
    HeaderComponent = __decorate([
        ...
        __metadata("design:paramtypes", [InvestorService, DashboardService])
    ], HeaderComponent);
